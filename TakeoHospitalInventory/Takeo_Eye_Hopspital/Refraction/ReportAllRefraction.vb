...
Public Class ReportAllRefraction
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportAllRefraction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportAllRefraction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportAllRefraction = New ReportAllRefraction
        rpt.Site = Me.Site
        Return rpt
    End Function
