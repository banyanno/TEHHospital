...
Partial Public Class DataSetCashCountDaily
    ...
    Partial Public Class tblPatientReceiptDataTable
        ...
        Public Overloads Function AddtblPatientReceiptRow( _
                    ...
                    ByVal Rates As Double) As tblPatientReceiptRow
            Dim rowtblPatientReceiptRow As tblPatientReceiptRow = CType(Me.NewRow,tblPatientReceiptRow)
            Dim columnValuesArray() As Object = New Object() {HN, ReceiptNo, CashUSD, CashRiel, ArtificialEyeFeeUSD, ArtificialEyeFeeRiel, OtherFeeUSD, OtherFeeRiel, MedicineFeeUSD, MedicineFeeRiel, GlassFeeUSD, GlassFeeRiel, DonationPay, CashTotal, DonatSupported, DateIn, OutPatientUSD, OutPatientRiel, InPatientUSD, InPatientRiel, Rates}
...
Namespace DataSetCashCountDailyTableAdapters
    ...
    Partial Public Class tblPatientReceiptTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT    HN, ReceiptNo, CONVERT(VARCHAR(11),DateIn,106) AS DateIn, CashUSD AS Ca"& _ 
                "shUSD, CashRiel AS CashRiel, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ConsultationFeeUSD + FollowUpFeeUSD AS OutPatient"& _ 
                "USD, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ConsultationFeeRiel + FollowUpFeeRiel AS OutPatientRiel, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"OperationFeeUS"& _ 
                "D  AS InPatientUSD, OperationFeeRiel AS InPatientRiel, GlassFeeUSD AS GlassFeeUS"& _ 
                "D, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"GlassFeeRiel AS GlassFeeRiel, ArtificialEyeFeeUSD AS ArtificialEyeFeeUSD,  "& _ 
                "ArtificialEyeFeeRiel AS ArtificialEyeFeeRiel,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"MedicineFeeRiel,MedicineFeeUSD, O"& _ 
                "therFeeUSD AS OtherFeeUSD, OtherFeeRiel AS OtherFeeRiel,DonationPay,CashTotal,Ra"& _ 
                "tes,"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"(case when ((IsDonation=1 and ConPay='1') and (DonationPay>0))  then (case"& _ 
                " when DonationPay=(CashUSD+(CashRiel/Rates)) then DonationPay else (DonationPay-"& _ 
                "(CashUSD+(CashRiel/Rates))) end)  else 0 end) as DonatSupported"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         tb"& _ 
                "lPatientReceipt"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"where  IsPatientNill=0  and ConPay='1' and ConDelete='0'"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"order"& _ 
                " by ReceiptNo"
            ...
            Me._commandCollection(1).CommandText = "SELECT ArtificialEyeFeeRiel, ArtificialEyeFeeUSD, CashRiel, CashTotal, CashUSD, C"& _ 
                ...
                "HN, MedicineFeeRiel, MedicineFeeUSD, OperationFeeRiel AS InPatientRiel, Operatio"& _ 
                "nFeeUSD AS InPatientUSD, OtherFeeRiel, OtherFeeUSD, ConsultationFeeRiel + Follow"& _ 
                "UpFeeRiel AS OutPatientRiel, ConsultationFeeUSD + FollowUpFeeUSD AS OutPatientUS"& _ 
                "D, Rates, ReceiptNo FROM tblPatientReceipt WHERE (IsPatientNill = 0) AND (ConPay"& _ 
                " = '1') AND (ConDelete = '0') AND (CAST(CONVERT (VARCHAR(10), DateIn, 1) AS Date"& _ 
                "Time) = CAST(CONVERT (VARCHAR(10), CAST(@DateIn AS DATETIME), 1) AS Datetime)) O"& _ 
                "RDER BY ReceiptNo"
            ...
            Me._commandCollection(2).CommandText = "SELECT ArtificialEyeFeeRiel, ArtificialEyeFeeUSD, CashRiel, CashTotal, CashUSD, C"& _ 
                ...
                "UpFeeRiel AS OutPatientRiel, ConsultationFeeUSD + FollowUpFeeUSD AS OutPatientUS"& _ 
                "D, Rates, ReceiptNo FROM tblPatientReceipt WHERE (IsPatientNill = 0) AND (ConPay"& _ 
                " = '1') AND    (CAST(CONVERT(VARCHAR(10), DateIn, 1) AS DateTime) BETWEEN CAST(C"& _ 
                "ONVERT(VARCHAR(10), CAST(@DFrom  AS DATETIME), 1) AS Datetime) AND "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"           "& _ 
                "           CAST(CONVERT(VARCHAR(10), CAST(@DTo AS DATETIME), 1) AS Datetime)) OR"& _ 
                "DER BY ReceiptNo"
