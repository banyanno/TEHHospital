...
Public Class ReportCashCountDailyv1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportCashCountDailyv1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportCashCountDailyv1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportCashCountDailyv1 = New ReportCashCountDailyv1
        rpt.Site = Me.Site
        Return rpt
    End Function
