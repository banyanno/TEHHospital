...
Public Class ReportReceiptDetailCR
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportReceiptDetailCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.ReportReceiptDetailCR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_txtReportName() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_txtDateFromTo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportReceiptDetailCR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportReceiptDetailCR = New ReportReceiptDetailCR
        rpt.Site = Me.Site
        Return rpt
    End Function
