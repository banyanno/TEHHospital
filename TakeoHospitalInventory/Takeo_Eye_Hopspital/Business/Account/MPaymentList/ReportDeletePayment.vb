...
Public Class ReportDeletePayment
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportDeletePayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDeletePayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDeletePayment = New ReportDeletePayment
        rpt.Site = Me.Site
        Return rpt
    End Function
