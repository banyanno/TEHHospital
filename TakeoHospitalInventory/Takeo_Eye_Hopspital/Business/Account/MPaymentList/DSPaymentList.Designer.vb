    ...
    Partial Public Class tblPatientReceiptTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT ID, ReceiptNo, IDCashReceipt, HN, PatientName, CashRiel, CashUSD, TotalRie"& _ 
                ...
                ", ConPay, ConDelete, Years, Operation, IsDonation, DonationID, DonationName, Don"& _ 
                "ationPay, DonateNote, HosFee, CashTotal, IsPatientNill FROM dbo.tblPatientReceip"& _ 
                "t"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"CAST(CONVERT(VARCHAR(10), DateIn, 1) AS DateTime) >=CAST(CONVERT(VARCH"& _ 
                "AR(10), CAST(@DATEIN AS DATETIME), 1) AS Datetime) and ConPay='0' and ConDelete="& _ 
                "'0' order by ReceiptNo ASC"
            ...
            Me._commandCollection(2).CommandText = "SELECT ID, ReceiptNo, IDCashReceipt, HN, PatientName, CashRiel, CashUSD, TotalRie"& _ 
                ...
                ", ConPay, ConDelete, Years, Operation, IsDonation, DonationID, DonationName, Don"& _ 
                "ationPay, DonateNote, HosFee, CashTotal, IsPatientNill FROM dbo.tblPatientReceip"& _ 
                "t"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ConPay='0' and ConDelete='0'  order by ReceiptNo Asc"
