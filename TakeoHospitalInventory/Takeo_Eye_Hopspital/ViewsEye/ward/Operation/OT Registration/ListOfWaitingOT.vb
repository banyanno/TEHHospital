...
Public Class ListOfWaitingOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.ListOfWaitingOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedListOfWaitingOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ListOfWaitingOT = New ListOfWaitingOT
        rpt.Site = Me.Site
        Return rpt
    End Function
