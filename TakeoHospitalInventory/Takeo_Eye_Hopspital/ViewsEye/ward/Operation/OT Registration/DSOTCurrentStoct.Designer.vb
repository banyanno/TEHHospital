...
Partial Public Class DSOTCurrentStoct
    ...
    Partial Public Class View_OTRegistrationDataTable
        ...
        Public Overloads Function AddView_OTRegistrationRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {OTNo, NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, OperationTime, Anesthesia, Anesthetist, Eye, OperationType, IOL, Surgeon, Assistant, Circulation, Compli, CreateDate, Status, DateOperated, Others, Waiting, DeleteOption, IOL_ID, IOL_ID_OLD, Referal, DR_NAME, TIME_CREATE}
    ...
    Partial Public Class View_OTRegistrationRow
        ...
        Public Property Referal() As String
            Get
                Try 
                    Return CType(Me(Me.tableView_OTRegistration.ReferalColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Referal' in table 'View_OTRegistration' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableView_OTRegistration.ReferalColumn) = value
            End Set
        End Property
        ...
        Public Function IsReferalNull() As Boolean
            Return Me.IsNull(Me.tableView_OTRegistration.ReferalColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetReferalNull()
            Me(Me.tableView_OTRegistration.ReferalColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class View_OTRegistrationTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        OTNo, NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Oper"& _ 
                ...
                " Circulation, Compli, CreateDate, Status, DateOperated, Others, Waiting, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                    DeleteOption, IOL_ID, IOL_ID_OLD, Referal, DR_NAME, TIME_CRE"& _ 
                "ATE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            View_OTRegistration"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        OTNo, NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Oper"& _ 
                ...
                " Circulation, Compli, CreateDate, Status, DateOperated, Others, Waiting, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"     "& _ 
                "                    DeleteOption, IOL_ID, IOL_ID_OLD, Referal, DR_NAME, TIME_CRE"& _ 
                "ATE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            View_OTRegistration"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE Waiting=2 AND Status='False' AND"& _ 
                " DeleteOption='False'"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As DSOTCurrentStoct.View_OTRegistrationDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As DSOTCurrentStoct.View_OTRegistrationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DSOTCurrentStoct.View_OTRegistrationDataTable = New DSOTCurrentStoct.View_OTRegistrationDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy(ByVal dataTable As DSOTCurrentStoct.View_OTRegistrationDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function SelectListWaitingOT() As DSOTCurrentStoct.View_OTRegistrationDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As DSOTCurrentStoct.View_OTRegistrationDataTable = New DSOTCurrentStoct.View_OTRegistrationDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
