...
Partial Public Class DSWardWithOT
    ...
    Partial Public Class V_NewInpatientDetialLeaveDataTable
        ...
        Public Overloads Function AddV_NewInpatientDetialLeaveRow( _
                    ...
                    ByVal IS_PATIEN_FOLLOWUP As Boolean) As V_NewInpatientDetialLeaveRow
    ...
    Partial Public Class V_NewInpatientDetialLeaveTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        NewInPatientNo, PatientNo, NameKhmer, Age, Sex, Address, Eye, Diagn"& _ 
                ...
                "aiting, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         TypeDiagnosis, DR_NAME, Telephone, IS_CALL, C"& _ 
                "ALL_DATE, CALL_NOTED, OTCANCEL, OTCANCEL_DATE, OTCANCEL_NOTE, OT_ISCANCEL, RECEI"& _ 
                "PT_NOM, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         DONATE_NAME, SURGERY_NAME, NameEng, IS_CALL_P"& _ 
                "OSTPONE, IS_PATIEN_FOLLOWUP"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            V_NewInpatientDetialLeave"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Address, Age, CALL_DATE, CALL_NOTED, CreateDate, DONATE_NAME, DR_NAME, Dat"& _ 
                ...
                "OLLOWUP, Leave, NameEng, NameKhmer, NewInPatientNo, OTCANCEL, OTCANCEL_DATE, OTC"& _ 
                "ANCEL_NOTE, OT_ISCANCEL, PatientNo, RECEIPT_NOM, SURGERY_NAME, Sex, Signature, T"& _ 
                "elephone, TypeDiagnosis, VA_LE, VA_RE, Waiting FROM V_NewInpatientDetialLeave WH"& _ 
                "ERE (OTCANCEL_DATE BETWEEN @DFrom AND @DTo) AND (OT_ISCANCEL = @OT_ISCANCEL)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
