...
Public Class CRNewInpatientWard
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CRNewInpatientWard.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PrintBy() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRNewInpatientWard
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRNewInpatientWard = New CRNewInpatientWard
        rpt.Site = Me.Site
        Return rpt
    End Function
