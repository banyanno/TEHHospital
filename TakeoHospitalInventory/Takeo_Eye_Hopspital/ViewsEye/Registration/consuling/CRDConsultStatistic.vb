...
Public Class CRDConsultStatistic
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRDConsultStatistic.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDConsultStatistic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDConsultStatistic = New CRDConsultStatistic
        rpt.Site = Me.Site
        Return rpt
    End Function
