...
Public Class CRVPatientCancellConsult
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRVPatientCancellConsult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVPatientCancellConsult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVPatientCancellConsult = New CRVPatientCancellConsult
        rpt.Site = Me.Site
        Return rpt
    End Function
