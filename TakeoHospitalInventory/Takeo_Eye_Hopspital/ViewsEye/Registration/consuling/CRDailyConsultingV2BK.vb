...
Public Class CRDailyConsultingV2BK
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRDailyConsultingV2BK.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CRDailyConsultingV2BK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDailyConsultingV2BK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDailyConsultingV2BK = New CRDailyConsultingV2BK
        rpt.Site = Me.Site
        Return rpt
    End Function
