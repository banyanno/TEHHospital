...
Public Class CRDailyConsultingV2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRDailyConsultingV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CRDailyConsultingV2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDailyConsultingV2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDailyConsultingV2 = New CRDailyConsultingV2
        rpt.Site = Me.Site
        Return rpt
    End Function
