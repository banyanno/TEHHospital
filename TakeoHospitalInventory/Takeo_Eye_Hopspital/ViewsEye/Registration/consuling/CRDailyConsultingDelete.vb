...
Public Class CRDailyConsultingDelete
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRDailyConsultingDelete.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDailyConsultingDelete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDailyConsultingDelete = New CRDailyConsultingDelete
        rpt.Site = Me.Site
        Return rpt
    End Function
