...
Partial Public Class DSDashboardPatient
    ...
    Partial Public Class TblPatientsDataTable
        ...
        Public Overloads Function AddTblPatientsRow( _
                    ...
                    ByVal OlePatientNo As Decimal) As TblPatientsRow
            Dim rowTblPatientsRow As TblPatientsRow = CType(Me.NewRow,TblPatientsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, PatientNo, CreateDate, Province, District, Commune, NameEng, NameKhmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, OlePatientNo}
    ...
    Partial Public Class TblPatientsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [TblPatients] ([PatientNo], [CreateDate], [Province], [District], [Co"& _ 
                ...
                "pation], [Telephone], [Neighborly], [OlePatientNo]) VALUES (@PatientNo, @CreateD"& _ 
                "ate, @Province, @District, @Commune, @NameEng, @NameKhmer, @Age, @Male, @Female,"& _ 
                " @Sex, @Address, @Occupation, @Telephone, @Neighborly, @OlePatientNo);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT N"& _ 
                "o, PatientNo, CreateDate, Province, District, Commune, NameEng, NameKhmer, Age, "& _ 
                "Male, Female, Sex, Address, Occupation, Telephone, Neighborly, OlePatientNo FROM"& _ 
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [TblPatients] SET [PatientNo] = @PatientNo, [CreateDate] = @CreateDate, [P"& _ 
                ...
                "] = @Telephone, [Neighborly] = @Neighborly, [OlePatientNo] = @OlePatientNo WHERE"& _ 
                " (([No] = @Original_No) AND ([PatientNo] = @Original_PatientNo) AND ((@IsNull_Cr"& _ 
                "eateDate = 1 AND [CreateDate] IS NULL) OR ([CreateDate] = @Original_CreateDate))"& _ 
                ...
                "] = @Original_Commune)) AND ((@IsNull_NameEng = 1 AND [NameEng] IS NULL) OR ([Na"& _ 
                "meEng] = @Original_NameEng)) AND ((@IsNull_NameKhmer = 1 AND [NameKhmer] IS NULL"& _ 
                ") OR ([NameKhmer] = @Original_NameKhmer)) AND ((@IsNull_Age = 1 AND [Age] IS NUL"& _ 
                "L) OR ([Age] = @Original_Age)) AND ((@IsNull_Male = 1 AND [Male] IS NULL) OR ([M"& _ 
                "ale] = @Original_Male)) AND ((@IsNull_Female = 1 AND [Female] IS NULL) OR ([Fema"& _ 
                "le] = @Original_Female)) AND ((@IsNull_Sex = 1 AND [Sex] IS NULL) OR ([Sex] = @O"& _ 
                "riginal_Sex)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @"& _ 
                "Original_Address)) AND ((@IsNull_Occupation = 1 AND [Occupation] IS NULL) OR ([O"& _ 
                "ccupation] = @Original_Occupation)) AND ((@IsNull_Telephone = 1 AND [Telephone] "& _ 
                "IS NULL) OR ([Telephone] = @Original_Telephone)) AND ((@IsNull_Neighborly = 1 AN"& _ 
                "D [Neighborly] IS NULL) OR ([Neighborly] = @Original_Neighborly)) AND ((@IsNull_"& _ 
                "OlePatientNo = 1 AND [OlePatientNo] IS NULL) OR ([OlePatientNo] = @Original_OleP"& _ 
                "atientNo)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT No, PatientNo, CreateDate, Province, District, Commune, Nam"& _ 
                "eEng, NameKhmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighbo"& _ 
                "rly, OlePatientNo FROM TblPatients WHERE (PatientNo = @PatientNo)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     No, PatientNo, CreateDate, Province, District, Commune, NameEng, NameK"& _ 
                "hmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                  OlePatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         TblPatients"
            ...
            Me._commandCollection(1).CommandText = "SELECT Address, Age, Commune, CreateDate, District, Female, Male, NameEng, NameKh"& _ 
                "mer, Neighborly, No, Occupation, OlePatientNo, PatientNo, Province, Sex, Telepho"& _ 
                "ne FROM TblPatients WHERE (PatientNo IS NOT NULL) AND (CAST(CONVERT (VARCHAR(10)"& _ 
                ", CreateDate, 1) AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DFrom AS "& _ 
                "DATETIME), 1) AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@DTo AS DATETIME)"& _ 
                ", 1) AS Datetime))"
            ...
            Me._commandCollection(2).CommandText = "SELECT Address, Age, Commune, CreateDate, District, Female, Male, NameEng, NameKh"& _ 
                "mer, Neighborly, No, Occupation, OlePatientNo, PatientNo, Province, Sex, Telepho"& _ 
                "ne FROM TblPatients WHERE (CAST(CONVERT (VARCHAR(10), CreateDate, 1) AS DateTime"& _ 
                ") BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DFrom AS DATETIME), 1) AS Datetime) A"& _ 
                "ND CAST(CONVERT (VARCHAR(10), CAST(@DTo AS DATETIME), 1) AS Datetime)) AND (Prov"& _ 
                "ince = @Province) AND (District = @District) AND (Commune = @Commune)"
            ...
            Me._commandCollection(3).CommandText = "SELECT Address, Age, Commune, CreateDate, District, Female, Male, NameEng, NameKh"& _ 
                ...
                "ne FROM TblPatients WHERE (CAST(CONVERT (VARCHAR(10), CreateDate, 1) AS DateTime"& _ 
                ") BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DFrom AS DATETIME), 1) AS Datetime) A"& _ 
                "ND CAST(CONVERT (VARCHAR(10), CAST(@DTo AS DATETIME), 1) AS Datetime)) AND (Name"& _ 
                "Khmer LIKE @KhmerName)"
            ...
            Me._commandCollection(4).CommandText = "SELECT Address, Age, Commune, CreateDate, District, Female, Male, NameEng, NameKh"& _ 
                ...
                "ne FROM TblPatients WHERE (CAST(CONVERT (VARCHAR(10), CreateDate, 1) AS DateTime"& _ 
                ") BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DFrom AS DATETIME), 1) AS Datetime) A"& _ 
                "ND CAST(CONVERT (VARCHAR(10), CAST(@DTo AS DATETIME), 1) AS Datetime)) AND (OleP"& _ 
                "atientNo = @OlePatientNo)"
            ...
            Me._commandCollection(5).CommandText = "SELECT Address, Age, Commune, CreateDate, District, Female, Male, NameEng, NameKh"& _ 
                ...
                "ne FROM TblPatients WHERE (CAST(CONVERT (VARCHAR(10), CreateDate, 1) AS DateTime"& _ 
                ") BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DFrom AS DATETIME), 1) AS Datetime) A"& _ 
                "ND CAST(CONVERT (VARCHAR(10), CAST(@DTo AS DATETIME), 1) AS Datetime)) AND (Pati"& _ 
                "entNo = @PatientNo)"
            ...
            Me._commandCollection(7).CommandText = "SELECT     No, PatientNo, CreateDate, Province, District, Commune, NameEng, NameK"& _ 
                "hmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                  OlePatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         TblPatients WHERE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"(CAST(CONVERT (V"& _ 
                "ARCHAR(10), CreateDate, 1) AS DateTime) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"BETWEEN CAST(CONVERT (VARCHAR(10), CAS"& _ 
                "T(@DFrom AS DATETIME), 1) AS Datetime) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND CAST(CONVERT (VARCHAR(10), CAST(@DT"& _ 
                "o AS DATETIME), 1) AS Datetime)) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (Province = @Province) AND (District = @D"& _ 
                "istrict) AND (Commune = @Commune)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (NameEng LIKE @NameEng)"
            ...
            Me._commandCollection(8).CommandText = "SELECT     No, PatientNo, CreateDate, Province, District, Commune, NameEng, NameK"& _ 
                "hmer, Age, Male, Female, Sex, Address, Occupation, Telephone, Neighborly, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"    "& _ 
                "                  OlePatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         TblPatients WHERE"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"(CAST(CONVERT (V"& _ 
                "ARCHAR(10), CreateDate, 1) AS DateTime) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"BETWEEN CAST(CONVERT (VARCHAR(10), CAS"& _ 
                "T(@DFrom AS DATETIME), 1) AS Datetime) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND CAST(CONVERT (VARCHAR(10), CAST(@DT"& _ 
                "o AS DATETIME), 1) AS Datetime)) "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND (Province = @Province) AND (District = @D"& _ 
                "istrict) AND (Commune = @Commune)"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"AND ( NameKhmer LIKE @NameKhmer)"
        ...
        Public Overloads Overridable Function Update( _
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_No,Decimal)
            Me.Adapter.UpdateCommand.Parameters(17).Value = CType(Original_PatientNo,Decimal)
            If (Original_CreateDate.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(18).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(Original_CreateDate.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(Original_Province,String)
            End If
            If (Original_District Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(23).Value = CType(Original_District,String)
            End If
            If (Original_Commune Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(25).Value = CType(Original_Commune,String)
            End If
            If (Original_NameEng Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(27).Value = CType(Original_NameEng,String)
            End If
            If (Original_NameKhmer Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(29).Value = CType(Original_NameKhmer,String)
            End If
            If (Original_Age.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(30).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(31).Value = CType(Original_Age.Value,Decimal)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(35).Value = CType(Original_Female,String)
            End If
            If (Original_Sex Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(37).Value = CType(Original_Sex,String)
            End If
            If (Original_Address Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(41).Value = CType(Original_Occupation,String)
            End If
            If (Original_Telephone Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(43).Value = CType(Original_Telephone,String)
            End If
            If (Original_Neighborly Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(45).Value = CType(Original_Neighborly,String)
            End If
            If (Original_OlePatientNo.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(46).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(47).Value = CType(Original_OlePatientNo.Value,Decimal)
            Else
