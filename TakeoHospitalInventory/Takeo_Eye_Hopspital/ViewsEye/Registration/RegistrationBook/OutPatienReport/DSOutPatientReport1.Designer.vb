...
Partial Public Class DSOutPatientReport
    ...
    Partial Public Class V_NewOutpatientDetail1DataTable
        ...
        Public Overloads Function AddV_NewOutpatientDetail1Row( _
                    ...
                    ByVal VA_PRight As String) As V_NewOutpatientDetail1Row
            Dim rowV_NewOutpatientDetail1Row As V_NewOutpatientDetail1Row = CType(Me.NewRow,V_NewOutpatientDetail1Row)
            Dim columnValuesArray() As Object = New Object() {NewOutPatientNo, PatientNo, OlePatientNo, ReceiptNo, NameEng, NameKhmer, Age, Sex, Address, PatientFee, PatientDolar, Diagnosis, Prescribed, Dispensed, Hearing, Understand, Seeing, Physical, Other, CreateDate, TypeDiagnosis, DeleteOption, VAStatus, Achieve, Male, Female, Status, ComBindRefferal, DeleteNote, Telephone, VA_PLeft, VA_PRight}
    ...
    Partial Public Class V_NewOutpatientDetailTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        NewOutPatientNo, PatientNo, OlePatientNo, ReceiptNo, NameEng, NameK"& _ 
                ...
                "sed, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Hearing, Understand, Seeing, Physical, Other, Cr"& _ 
                "eateDate, TypeDiagnosis, DeleteOption, VAStatus, Achieve, Male, Female, Status, "& _ 
                "ComBindRefferal, DeleteNote, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Telephone"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         "& _ 
                "   V_NewOutpatientDetail"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, DeleteOpti"& _ 
                ...
                "ntNo, OlePatientNo, Other, PatientDolar, PatientFee, PatientNo, Physical, Prescr"& _ 
                "ibed, ReceiptNo, Seeing, Sex, Status, Telephone, TypeDiagnosis, Understand, VASt"& _ 
                "atus FROM V_NewOutpatientDetail WHERE (CAST(CONVERT (VARCHAR(10), CreateDate, 1)"& _ 
                " AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DateFrom AS DATETIME), 1)"& _ 
                " AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@DateTo AS DATETIME), 1) AS Da"& _ 
                "tetime)) AND (Status = @Status) AND (RTRIM(LTRIM(Diagnosis)) = RTRIM(LTRIM('')))"& _ 
                " ORDER BY NewOutPatientNo"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateFrom", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateTo", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._commandCollection(3).CommandText = "SELECT Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, DeleteOpti"& _ 
                ...
                " AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DateFrom AS DATETIME), 1)"& _ 
                " AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@DateTo AS DATETIME), 1) AS Da"& _ 
                "tetime)) AND (Diagnosis = @Diagnosis) AND (Status = @Status)"
            Me._commandCollection(3).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateFrom", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateTo", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._commandCollection(4).CommandText = "SELECT Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, DeleteOpti"& _ 
                ...
                " AS DateTime) BETWEEN CAST(CONVERT (VARCHAR(10), CAST(@DateFrom AS DATETIME), 1)"& _ 
                " AS Datetime) AND CAST(CONVERT (VARCHAR(10), CAST(@DateTo AS DATETIME), 1) AS Da"& _ 
                "tetime)) AND (DeleteOption = 1) AND (Status = @Status)"
    ...
    Partial Public Class V_NewOutpatientDetail1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, Del"& _ 
                "eteOption, Diagnosis, Dispensed, Female, Hearing, Male, NameEng, NameKhmer, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                       NewOutPatientNo, OlePatientNo, Other, PatientDolar, Patie"& _ 
                "ntFee, PatientNo, Physical, Prescribed, ReceiptNo, Seeing, Sex, Status, Telephon"& _ 
                "e, TypeDiagnosis, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Understand, VAStatus, VA_PLeft, VA_"& _ 
                "PRight"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            V_NewOutpatientDetail"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Status = 0) AND (Di"& _ 
                "agnosis <> '') AND (DeleteOption = 0) AND (PatientNo NOT IN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "          (SELECT        PatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               FROM         "& _ 
                "   VIEW_PATIENT_OPERATORED))"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, Del"& _ 
                "eteOption, Diagnosis, Dispensed, Female, Hearing, Male, NameEng, NameKhmer, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"  "& _ 
                "                       NewOutPatientNo, OlePatientNo, Other, PatientDolar, Patie"& _ 
                "ntFee, PatientNo, Physical, Prescribed, ReceiptNo, Seeing, Sex, Status, Telephon"& _ 
                "e, TypeDiagnosis, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Understand, VAStatus, VA_PLeft, VA_"& _ 
                ...
                "agnosis <> '') AND (DeleteOption = 0) AND (PatientNo NOT IN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                   "& _ 
                "          (SELECT        PatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               FROM         "& _ 
                "   VIEW_PATIENT_OPERATORED"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               WHERE        (DeleteO"& _ 
                "ption = 0))) AND (CAST(CONVERT(VARCHAR(10), CreateDate, 1) AS DateTime) BETWEEN "& _ 
                ...
                " Datetime))"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"ORDER BY PatientNo"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateFrom", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateTo", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
