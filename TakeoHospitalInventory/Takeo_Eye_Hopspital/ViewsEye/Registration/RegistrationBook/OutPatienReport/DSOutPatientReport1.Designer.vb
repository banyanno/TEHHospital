...
Partial Public Class DSOutPatientReport
    ...
    Partial Public Class V_NewOutpatientDetail1DataTable
        ...
        Public Overloads Function AddV_NewOutpatientDetail1Row( _
                    ...
                    ByVal ConsultByDR As String) As V_NewOutpatientDetail1Row
            Dim rowV_NewOutpatientDetail1Row As V_NewOutpatientDetail1Row = CType(Me.NewRow,V_NewOutpatientDetail1Row)
            Dim columnValuesArray() As Object = New Object() {NewOutPatientNo, PatientNo, OlePatientNo, ReceiptNo, NameEng, NameKhmer, Age, Sex, Address, PatientFee, PatientDolar, Diagnosis, Prescribed, Dispensed, Hearing, Understand, Seeing, Physical, Other, CreateDate, TypeDiagnosis, DeleteOption, VAStatus, Achieve, Male, Female, Status, ComBindRefferal, DeleteNote, Telephone, VA_PLeft, VA_PRight, Occupation, ConsultByDR}
    ...
    Partial Public Class V_NewOutpatientDetail1Row
        ...
        Public Property ConsultByDR() As String
            Get
                Try 
                    Return CType(Me(Me.tableV_NewOutpatientDetail1.ConsultByDRColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ConsultByDR' in table 'V_NewOutpatientDetail1' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableV_NewOutpatientDetail1.ConsultByDRColumn) = value
            End Set
        End Property
        ...
        Public Function IsConsultByDRNull() As Boolean
            Return Me.IsNull(Me.tableV_NewOutpatientDetail1.ConsultByDRColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetConsultByDRNull()
            Me(Me.tableV_NewOutpatientDetail1.ConsultByDRColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class V_NewOutpatientDetail1TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Achieve, Address, Age, ComBindRefferal, CreateDate, DeleteNote, Del"& _ 
                ...
                "e, TypeDiagnosis, Understand, VAStatus, VA_PLeft, VA_PRight, Occupation, Consult"& _ 
                "ByDR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            V_NewOutpatientDetail"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Status = 0) AND (Diag"& _ 
                "nosis <> '') AND (DeleteOption = 0) AND (PatientNo NOT IN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                     "& _ 
                "        (SELECT        PatientNo"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                               FROM           "& _ 
                " VIEW_PATIENT_OPERATORED))"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Achieve, Address, Age, ComBindRefferal, ConsultByDR, CreateDate, DeleteNot"& _ 
                "e, DeleteOption, Diagnosis, Dispensed, Female, Hearing, Male, NameEng, NameKhmer"& _ 
                ", NewOutPatientNo, Occupation, OlePatientNo, Other, PatientDolar, PatientFee, Pa"& _ 
                "tientNo, Physical, Prescribed, ReceiptNo, Seeing, Sex, Status, Telephone, TypeDi"& _ 
                "agnosis, Understand, VAStatus, VA_PLeft, VA_PRight FROM V_NewOutpatientDetail WH"& _ 
                "ERE (Status = 0) AND (Diagnosis <> '') AND (DeleteOption = 0) AND (PatientNo NOT"& _ 
                " IN (SELECT PatientNo FROM VIEW_PATIENT_OPERATORED WHERE (DeleteOption = 0))) AN"& _ 
                "D (CAST(CONVERT (VARCHAR(10), CreateDate, 1) AS DateTime) BETWEEN CAST(CONVERT ("& _ 
                "VARCHAR(10), CAST(@DateFrom AS DATETIME), 1) AS Datetime) AND CAST(CONVERT (VARC"& _ 
                "HAR(10), CAST(@DateTo AS DATETIME), 1) AS Datetime)) ORDER BY PatientNo"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateFrom", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DateTo", Global.System.Data.SqlDbType.DateTime, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
