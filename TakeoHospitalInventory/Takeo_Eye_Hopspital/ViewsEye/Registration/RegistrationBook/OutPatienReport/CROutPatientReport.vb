...
Public Class CROutPatientReport
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Label_Title() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCROutPatientReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CROutPatientReport = New CROutPatientReport
        rpt.Site = Me.Site
        Return rpt
    End Function
