...
Public Class ReportPatientOldNewCancel
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportPatientOldNewCancel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportPatientOldNewCancel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportPatientOldNewCancel = New ReportPatientOldNewCancel
        rpt.Site = Me.Site
        Return rpt
    End Function
