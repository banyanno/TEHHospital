...
Public Class CryPatientReferalByAge
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryPatientReferalByAge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPatientReferalByAge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPatientReferalByAge = New CryPatientReferalByAge
        rpt.Site = Me.Site
        Return rpt
    End Function
