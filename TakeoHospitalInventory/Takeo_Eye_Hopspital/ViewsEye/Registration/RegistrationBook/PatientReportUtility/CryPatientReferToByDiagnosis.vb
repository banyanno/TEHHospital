...
Public Class CryPatientReferToByDiagnosis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CryPatientReferToByDiagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryPatientReferToByDiagnosis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryPatientReferToByDiagnosis = New CryPatientReferToByDiagnosis
        rpt.Site = Me.Site
        Return rpt
    End Function
