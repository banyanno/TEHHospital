...
Public Class CRPatientDisabilityByAge
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPatientDisabilityByAge.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPatientDisabilityByAge
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPatientDisabilityByAge = New CRPatientDisabilityByAge
        rpt.Site = Me.Site
        Return rpt
    End Function
