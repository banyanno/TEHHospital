...
Public Class CrvDisabilityDetail
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrvDisabilityDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrvDisabilityDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrvDisabilityDetail = New CrvDisabilityDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
