...
Public Class CRPCombindPateintDisability
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRPCombindPateintDisability.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRPCombindPateintDisability
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRPCombindPateintDisability = New CRPCombindPateintDisability
        rpt.Site = Me.Site
        Return rpt
    End Function
