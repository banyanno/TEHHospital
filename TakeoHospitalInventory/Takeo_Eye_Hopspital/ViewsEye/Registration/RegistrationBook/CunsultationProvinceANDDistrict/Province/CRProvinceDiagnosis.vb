...
Public Class CRProvinceDiagnosis
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRProvinceDiagnosis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProvinceDiagnosis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProvinceDiagnosis = New CRProvinceDiagnosis
        rpt.Site = Me.Site
        Return rpt
    End Function
