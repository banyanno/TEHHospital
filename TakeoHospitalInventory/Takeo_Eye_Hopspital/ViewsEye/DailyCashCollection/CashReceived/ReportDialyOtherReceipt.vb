...
Public Class ReportDialyOtherReceipt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportDialyOtherReceipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDialyOtherReceipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDialyOtherReceipt = New ReportDialyOtherReceipt
        rpt.Site = Me.Site
        Return rpt
    End Function
