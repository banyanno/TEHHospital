        ...
        Else
            ...
            Else
                If MessageBox.Show("Do you want update receipt?", "Other Receipt", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                    ...
                    End If
                    DA_SystemTracking.InsertNewSystemTracking(Now, Now.Date, "Other Receipt", " Patient No:" & TxtPatientNo.Text & " Regist Date: " & DateReceiptIn.Value.Date & " Amount:" & TxtCashReceived.Text & " " & IIf(RadDolar.Checked = True, "$", "R") & " By user:" & USER_NAME, txtReceiptNumber.Text, "UPDATE")
                    Application.DoEvents()
