...
Partial Public Class DSPharmacy
    ...
    Partial Public Class VPRESCRIP_MAIN_INVENTORYDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddVPRESCRIP_MAIN_INVENTORYRow(ByVal PrescripID As Decimal, ByVal Surgery As String, ByVal DoctorNo As Decimal, ByVal IssueDate As Date, ByVal DiagnosisID As Decimal, ByVal DoctorName As String, ByVal PatientNo As Decimal, ByVal NameEng As String, ByVal Status As Integer, ByVal Age As Decimal, ByVal Sex As String, ByVal Address As String, ByVal Telephone As String, ByVal PrescriptionNote As String) As VPRESCRIP_MAIN_INVENTORYRow
            Dim rowVPRESCRIP_MAIN_INVENTORYRow As VPRESCRIP_MAIN_INVENTORYRow = CType(Me.NewRow,VPRESCRIP_MAIN_INVENTORYRow)
            Dim columnValuesArray() As Object = New Object() {PrescripID, Surgery, DoctorNo, IssueDate, DiagnosisID, DoctorName, PatientNo, NameEng, Status, Age, Sex, Address, Telephone, PrescriptionNote}
    ...
    Partial Public Class VPRESCRIP_MAIN_INVENTORYTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        PrescripID, Surgery, DoctorNo, IssueDate, DiagnosisID, DoctorName, "& _ 
                "PatientNo, NameEng, Status, Age, Sex, Address, Telephone, PrescriptionNote"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "            VPRESCRIP_MAIN_INVENTORY"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (PrescripID = @PrescripID)"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(2).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (IssueDate BETWEEN @FROM AND @TO)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(3).CommandText = "SELECT        Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng"& _ 
                ", PatientNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM"& _ 
                "            VPRESCRIP_MAIN_INVENTORY"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (Status = 0)"
            ...
            Me._commandCollection(4).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (DoctorNo = @DoctorNo) AND (IssueDate BETWEEN @DFrom AND"& _ 
                " @Dto)"
            ...
            Me._commandCollection(5).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (PatientNo = @PatientNo)"
            ...
            Me._commandCollection(6).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (Status = @Status) AND (IssueDate BETWEEN @From AND @TO)"& _ 
                ""
            ...
            Me._commandCollection(7).CommandText = "SELECT Address, Age, DiagnosisID, DoctorName, DoctorNo, IssueDate, NameEng, Patie"& _ 
                "ntNo, PrescripID, PrescriptionNote, Sex, Status, Surgery, Telephone FROM VPRESCR"& _ 
                "IP_MAIN_INVENTORY WHERE (Status = 1)"
