...
Partial Public Class DSPharmacy_V1
    ...
    Partial Public Class TblNew_Old_OutPatientDataTable
        ...
        Private columnConsultByDR As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property ConsultByDRColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnConsultByDR
            End Get
        End Property
        ...
        Public Overloads Function AddTblNew_Old_OutPatientRow( _
                    ...
                    ByVal ConsultByDR As String) As TblNew_Old_OutPatientRow
            Dim rowTblNew_Old_OutPatientRow As TblNew_Old_OutPatientRow = CType(Me.NewRow,TblNew_Old_OutPatientRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, PatientFee, PatientDolar, Prescribed, Dispensed, Hearing, Understand, Seeing, Physical, Other, CreateDate, Status, TypeDiagnosis, DeleteOption, VAStatus, ComBindRefferal, ConsultByDR}
        ...
        Friend Sub InitVars()
            ...
            Me.columnConsultByDR = MyBase.Columns("ConsultByDR")
        End Sub
        ...
        Private Sub InitClass()
            ...
            Me.columnConsultByDR = New Global.System.Data.DataColumn("ConsultByDR", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnConsultByDR)
            ...
            Me.columnConsultByDR.MaxLength = 50
        End Sub
    ...
    Partial Public Class TblNew_Old_OutPatientRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property ConsultByDR() As String
            Get
                Try 
                    Return CType(Me(Me.tableTblNew_Old_OutPatient.ConsultByDRColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'ConsultByDR' in table 'TblNew_Old_OutPatient' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTblNew_Old_OutPatient.ConsultByDRColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsConsultByDRNull() As Boolean
            Return Me.IsNull(Me.tableTblNew_Old_OutPatient.ConsultByDRColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetConsultByDRNull()
            Me(Me.tableTblNew_Old_OutPatient.ConsultByDRColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DSPharmacy_V1TableAdapters
    ...
    Partial Public Class TblNew_Old_OutPatientTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            tableMapping.ColumnMappings.Add("ConsultByDR", "ConsultByDR")
            Me._adapter.TableMappings.Add(tableMapping)
            Me._adapter.DeleteCommand = New Global.System.Data.SqlClient.SqlCommand
            Me._adapter.DeleteCommand.Connection = Me.Connection
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [TblNew_Old_OutPatient] WHERE (([NewOutPatientNo] = @Original_NewOutP"& _ 
                "atientNo) AND ((@IsNull_ReceiptNo = 1 AND [ReceiptNo] IS NULL) OR ([ReceiptNo] ="& _ 
                " @Original_ReceiptNo)) AND ((@IsNull_PatientNo = 1 AND [PatientNo] IS NULL) OR ("& _ 
                "[PatientNo] = @Original_PatientNo)) AND ((@IsNull_Diagnosis = 1 AND [Diagnosis] "& _ 
                "IS NULL) OR ([Diagnosis] = @Original_Diagnosis)) AND ((@IsNull_DiagnosisTem = 1 "& _ 
                "AND [DiagnosisTem] IS NULL) OR ([DiagnosisTem] = @Original_DiagnosisTem)) AND (("& _ 
                "@IsNull_PatientFee = 1 AND [PatientFee] IS NULL) OR ([PatientFee] = @Original_Pa"& _ 
                "tientFee)) AND ((@IsNull_PatientDolar = 1 AND [PatientDolar] IS NULL) OR ([Patie"& _ 
                "ntDolar] = @Original_PatientDolar)) AND ((@IsNull_Prescribed = 1 AND [Prescribed"& _ 
                "] IS NULL) OR ([Prescribed] = @Original_Prescribed)) AND ((@IsNull_Dispensed = 1"& _ 
                " AND [Dispensed] IS NULL) OR ([Dispensed] = @Original_Dispensed)) AND ((@IsNull_"& _ 
                "Hearing = 1 AND [Hearing] IS NULL) OR ([Hearing] = @Original_Hearing)) AND ((@Is"& _ 
                "Null_Understand = 1 AND [Understand] IS NULL) OR ([Understand] = @Original_Under"& _ 
                "stand)) AND ((@IsNull_Seeing = 1 AND [Seeing] IS NULL) OR ([Seeing] = @Original_"& _ 
                "Seeing)) AND ((@IsNull_Physical = 1 AND [Physical] IS NULL) OR ([Physical] = @Or"& _ 
                "iginal_Physical)) AND ((@IsNull_Other = 1 AND [Other] IS NULL) OR ([Other] = @Or"& _ 
                "iginal_Other)) AND ((@IsNull_CreateDate = 1 AND [CreateDate] IS NULL) OR ([Creat"& _ 
                "eDate] = @Original_CreateDate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) O"& _ 
                "R ([Status] = @Original_Status)) AND ((@IsNull_TypeDiagnosis = 1 AND [TypeDiagno"& _ 
                "sis] IS NULL) OR ([TypeDiagnosis] = @Original_TypeDiagnosis)) AND ((@IsNull_Dele"& _ 
                "teOption = 1 AND [DeleteOption] IS NULL) OR ([DeleteOption] = @Original_DeleteOp"& _ 
                "tion)) AND ((@IsNull_VAStatus = 1 AND [VAStatus] IS NULL) OR ([VAStatus] = @Orig"& _ 
                "inal_VAStatus)) AND ((@IsNull_ComBindRefferal = 1 AND [ComBindRefferal] IS NULL)"& _ 
                " OR ([ComBindRefferal] = @Original_ComBindRefferal)) AND ((@IsNull_ConsultByDR ="& _ 
                " 1 AND [ConsultByDR] IS NULL) OR ([ConsultByDR] = @Original_ConsultByDR)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_ConsultByDR", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_ConsultByDR", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [TblNew_Old_OutPatient] ([ReceiptNo], [PatientNo], [Diagnosis], [Diag"& _ 
                "nosisTem], [PatientFee], [PatientDolar], [Prescribed], [Dispensed], [Hearing], ["& _ 
                "Understand], [Seeing], [Physical], [Other], [CreateDate], [Status], [TypeDiagnos"& _ 
                "is], [DeleteOption], [VAStatus], [ComBindRefferal], [ConsultByDR]) VALUES (@Rece"& _ 
                "iptNo, @PatientNo, @Diagnosis, @DiagnosisTem, @PatientFee, @PatientDolar, @Presc"& _ 
                "ribed, @Dispensed, @Hearing, @Understand, @Seeing, @Physical, @Other, @CreateDat"& _ 
                "e, @Status, @TypeDiagnosis, @DeleteOption, @VAStatus, @ComBindRefferal, @Consult"& _ 
                "ByDR);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT NewOutPatientNo, ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, P"& _ 
                "atientFee, PatientDolar, Prescribed, Dispensed, Hearing, Understand, Seeing, Phy"& _ 
                "sical, Other, CreateDate, Status, TypeDiagnosis, DeleteOption, VAStatus, ComBind"& _ 
                "Refferal, ConsultByDR FROM TblNew_Old_OutPatient WHERE (NewOutPatientNo = SCOPE_"& _ 
                "IDENTITY())"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ConsultByDR", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [TblNew_Old_OutPatient] SET [ReceiptNo] = @ReceiptNo, [PatientNo] = @Patie"& _ 
                "ntNo, [Diagnosis] = @Diagnosis, [DiagnosisTem] = @DiagnosisTem, [PatientFee] = @"& _ 
                "PatientFee, [PatientDolar] = @PatientDolar, [Prescribed] = @Prescribed, [Dispens"& _ 
                "ed] = @Dispensed, [Hearing] = @Hearing, [Understand] = @Understand, [Seeing] = @"& _ 
                "Seeing, [Physical] = @Physical, [Other] = @Other, [CreateDate] = @CreateDate, [S"& _ 
                "tatus] = @Status, [TypeDiagnosis] = @TypeDiagnosis, [DeleteOption] = @DeleteOpti"& _ 
                "on, [VAStatus] = @VAStatus, [ComBindRefferal] = @ComBindRefferal, [ConsultByDR] "& _ 
                "= @ConsultByDR WHERE (([NewOutPatientNo] = @Original_NewOutPatientNo) AND ((@IsN"& _ 
                "ull_ReceiptNo = 1 AND [ReceiptNo] IS NULL) OR ([ReceiptNo] = @Original_ReceiptNo"& _ 
                ")) AND ((@IsNull_PatientNo = 1 AND [PatientNo] IS NULL) OR ([PatientNo] = @Origi"& _ 
                "nal_PatientNo)) AND ((@IsNull_Diagnosis = 1 AND [Diagnosis] IS NULL) OR ([Diagno"& _ 
                "sis] = @Original_Diagnosis)) AND ((@IsNull_DiagnosisTem = 1 AND [DiagnosisTem] I"& _ 
                "S NULL) OR ([DiagnosisTem] = @Original_DiagnosisTem)) AND ((@IsNull_PatientFee ="& _ 
                " 1 AND [PatientFee] IS NULL) OR ([PatientFee] = @Original_PatientFee)) AND ((@Is"& _ 
                "Null_PatientDolar = 1 AND [PatientDolar] IS NULL) OR ([PatientDolar] = @Original"& _ 
                "_PatientDolar)) AND ((@IsNull_Prescribed = 1 AND [Prescribed] IS NULL) OR ([Pres"& _ 
                "cribed] = @Original_Prescribed)) AND ((@IsNull_Dispensed = 1 AND [Dispensed] IS "& _ 
                "NULL) OR ([Dispensed] = @Original_Dispensed)) AND ((@IsNull_Hearing = 1 AND [Hea"& _ 
                "ring] IS NULL) OR ([Hearing] = @Original_Hearing)) AND ((@IsNull_Understand = 1 "& _ 
                "AND [Understand] IS NULL) OR ([Understand] = @Original_Understand)) AND ((@IsNul"& _ 
                "l_Seeing = 1 AND [Seeing] IS NULL) OR ([Seeing] = @Original_Seeing)) AND ((@IsNu"& _ 
                "ll_Physical = 1 AND [Physical] IS NULL) OR ([Physical] = @Original_Physical)) AN"& _ 
                "D ((@IsNull_Other = 1 AND [Other] IS NULL) OR ([Other] = @Original_Other)) AND ("& _ 
                "(@IsNull_CreateDate = 1 AND [CreateDate] IS NULL) OR ([CreateDate] = @Original_C"& _ 
                "reateDate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Origi"& _ 
                "nal_Status)) AND ((@IsNull_TypeDiagnosis = 1 AND [TypeDiagnosis] IS NULL) OR ([T"& _ 
                "ypeDiagnosis] = @Original_TypeDiagnosis)) AND ((@IsNull_DeleteOption = 1 AND [De"& _ 
                "leteOption] IS NULL) OR ([DeleteOption] = @Original_DeleteOption)) AND ((@IsNull"& _ 
                "_VAStatus = 1 AND [VAStatus] IS NULL) OR ([VAStatus] = @Original_VAStatus)) AND "& _ 
                "((@IsNull_ComBindRefferal = 1 AND [ComBindRefferal] IS NULL) OR ([ComBindReffera"& _ 
                "l] = @Original_ComBindRefferal)) AND ((@IsNull_ConsultByDR = 1 AND [ConsultByDR]"& _ 
                " IS NULL) OR ([ConsultByDR] = @Original_ConsultByDR)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT NewOutPatientNo,"& _ 
                " ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, PatientFee, PatientDolar, Prescr"& _ 
                "ibed, Dispensed, Hearing, Understand, Seeing, Physical, Other, CreateDate, Statu"& _ 
                "s, TypeDiagnosis, DeleteOption, VAStatus, ComBindRefferal, ConsultByDR FROM TblN"& _ 
                "ew_Old_OutPatient WHERE (NewOutPatientNo = @NewOutPatientNo)"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ConsultByDR", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IsNull_ConsultByDR", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Original, true, Nothing, "", "", ""))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_ConsultByDR", Global.System.Data.SqlDbType.NVarChar, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        NewOutPatientNo, ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, Pat"& _ 
                "ientFee, PatientDolar, Prescribed, Dispensed, Hearing, Understand, Seeing, Physi"& _ 
                "cal, Other, CreateDate, Status, TypeDiagnosis, DeleteOption, VAStatus, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  ComBindRefferal, ConsultByDR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            TblNew_Old_OutPa"& _ 
                "tient"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT        NewOutPatientNo, ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, Pat"& _ 
                "ientFee, PatientDolar, Prescribed, Dispensed, Hearing, Understand, Seeing, Physi"& _ 
                "cal, Other, CreateDate, Status, TypeDiagnosis, DeleteOption, VAStatus, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  ComBindRefferal, ConsultByDR"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            TblNew_Old_OutPa"& _ 
                "tient"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"Where"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"PatientNo=@PatientNo and ConsultByDR=@ConsultByDR"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@ConsultByDR", Global.System.Data.SqlDbType.NVarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "ConsultByDR", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            Me._commandCollection(2) = New Global.System.Data.SqlClient.SqlCommand
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT NewOutPatientNo, ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, PatientFee"& _ 
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy(ByVal dataTable As DSPharmacy_V1.TblNew_Old_OutPatientDataTable, ByVal PatientNo As Global.System.Nullable(Of Decimal), ByVal ConsultByDR As String) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(0).Value = Global.System.DBNull.Value
            End If
            If (ConsultByDR Is Nothing) Then
                Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = CType(ConsultByDR,String)
            End If
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function SelectPatientByDrName(ByVal PatientNo As Global.System.Nullable(Of Decimal), ByVal ConsultByDR As String) As DSPharmacy_V1.TblNew_Old_OutPatientDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (PatientNo.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(PatientNo.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Delete( _
                    ...
                    ByVal Original_ConsultByDR As String) As Integer
            ...
            End If
            If (Original_ConsultByDR Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(39).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(40).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(39).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(40).Value = CType(Original_ConsultByDR,String)
            End If
        ...
        Public Overloads Overridable Function Insert( _
                    ...
                    ByVal ComBindRefferal As String,  _
                    ByVal ConsultByDR As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(19).Value = CType(ConsultByDR,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_VAStatus As Global.System.Nullable(Of Boolean),  _
                    ByVal Original_ComBindRefferal As String,  _
                    ByVal Original_ConsultByDR As String,  _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(19).Value = CType(ConsultByDR,String)
            End If
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(60).Value = CType(Original_ConsultByDR,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_ComBindRefferal As String,  _
                    ByVal Original_ConsultByDR As String) As Integer
            Return Me.Update(ReceiptNo, PatientNo, Diagnosis, DiagnosisTem, PatientFee, PatientDolar, Prescribed, Dispensed, Hearing, Understand, Seeing, Physical, Other, CreateDate, Status, TypeDiagnosis, DeleteOption, VAStatus, ComBindRefferal, ConsultByDR, Original_NewOutPatientNo, Original_ReceiptNo, Original_PatientNo, Original_Diagnosis, Original_DiagnosisTem, Original_PatientFee, Original_PatientDolar, Original_Prescribed, Original_Dispensed, Original_Hearing, Original_Understand, Original_Seeing, Original_Physical, Original_Other, Original_CreateDate, Original_Status, Original_TypeDiagnosis, Original_DeleteOption, Original_VAStatus, Original_ComBindRefferal, Original_ConsultByDR, Original_NewOutPatientNo)
        End Function
    End Class
