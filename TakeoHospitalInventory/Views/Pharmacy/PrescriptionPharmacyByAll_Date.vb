...
Public Class PrescriptionPharmacyByAll_Date
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PrescriptionPharmacyByAll_Date.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.PrescriptionPharmacyByAll_Date.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Title_Prescription() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPrescriptionPharmacyByAll_Date
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrescriptionPharmacyByAll_Date = New PrescriptionPharmacyByAll_Date
        rpt.Site = Me.Site
        Return rpt
    End Function
