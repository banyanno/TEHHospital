...
Public Class CryReceipt_V2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CryReceipt_V2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryReceipt_V2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryReceipt_V2 = New CryReceipt_V2
        rpt.Site = Me.Site
        Return rpt
    End Function
