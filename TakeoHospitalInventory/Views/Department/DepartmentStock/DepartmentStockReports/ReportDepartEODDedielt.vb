...
Public Class ReportDepartEODDedielt
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportDepartEODDedielt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportDepartEODDedielt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportDepartEODDedielt = New ReportDepartEODDedielt
        rpt.Site = Me.Site
        Return rpt
    End Function
