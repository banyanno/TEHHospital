...
Public Class RptItemHospitalProject
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptItemHospitalProject.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptItemHospitalProject
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptItemHospitalProject = New RptItemHospitalProject
        rpt.Site = Me.Site
        Return rpt
    End Function
