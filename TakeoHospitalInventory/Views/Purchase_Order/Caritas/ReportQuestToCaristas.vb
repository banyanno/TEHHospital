...
Public Class ReportQuestToCaristas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportQuestToCaristas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportQuestToCaristas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportQuestToCaristas = New ReportQuestToCaristas
        rpt.Site = Me.Site
        Return rpt
    End Function
