...
Public Class CrRequestOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CrRequestOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pRequestFromDepart() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrRequestOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrRequestOrder = New CrRequestOrder
        rpt.Site = Me.Site
        Return rpt
    End Function
