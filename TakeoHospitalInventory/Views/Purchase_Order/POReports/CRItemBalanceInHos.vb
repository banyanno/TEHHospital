...
Public Class CRItemBalanceInHos
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_PCate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCRItemBalanceInHos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRItemBalanceInHos = New CRItemBalanceInHos
        rpt.Site = Me.Site
        Return rpt
    End Function
