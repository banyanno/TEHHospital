...
Public Class ReportSystemTracking
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReportSystemTracking.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.ReportSystemTracking.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DateToDate() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReportSystemTracking
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportSystemTracking = New ReportSystemTracking
        rpt.Site = Me.Site
        Return rpt
    End Function
